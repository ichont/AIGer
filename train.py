...
def parameter_parser():
    ...
    parser.add_argument('--epochs', type=int, default=600)# 请修改你的epoch
    parser.add_argument('--lr', type=float, default=0.01)# 学习率有点太大，波动明显？
    parser.add_argument('--weight_decay', type=float, default=1e-3)
    parser.add_argument('--model', type=str, default='AIGer')
    parser.add_argument('--seed', type=int, default=2024)
    parser.add_argument('--in_dim', type=int, default=3)
    parser.add_argument('--out_dim', type=int, default=256)
    parser.add_argument('--eval_step', type=int, default=1)
    parser.add_argument('--patience', type=int, default=500) # 耐心值我调整为500，原来是50
    parser.add_argument('--layer_num', type=int, default=3)
    parser.add_argument('--device', type=int, default=-1)
    parser.add_argument('--runs', type=int, default=1, help='number of distinct runs')
    parser.add_argument('--batch_size', type=int, default=32)
    parser.add_argument('--num_workers', type=int, default=1)
    parser.add_argument('--split_file', type=str, default='0.05-0.05-0.9') # 标签比例选择
    ...
    # 请调整路径
    args.data_root_path = Path('C:/py').joinpath('AIGDataset', args.dataset)
...
def load_data_signed_parallel_train(args, graph_dirs, pi_edges_dict, tt_pair_dict):
    total_data = []
    node_counts = []
    def process_data(data_dir):
        ...
        #node_counts.append((len(total_data), num_nodes))  # 记录图的索引和节点数量
...
def parse_data_parallel(args):
    ...
    train_data = load_data_signed_parallel_train(args, train_file, pi_edges_dict, tt_pair_dict)
...
def load_model(args):
    ...
    model = AIGer(args=args, node_num=0, device=args.device, in_dim=in_dim, out_dim=out_dim,
